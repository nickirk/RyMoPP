...
//===========================================================================
double qSimpsonAngT(double Func(double,double,double, double, double, int, int,int,int,int,int,int,int,int),
 int nt, int np, double x, double RadialP_R, double RadialP_dR, int N,int n,int l,int m, int dj,int n1,int l1,int m1,int dj1)
//---------------------------------------------------------------------------
...
#define pi 3.141592653589793
   ...
   for (i=1; i<=nt; i++) {
      st = 0e0;
      for (j=1; j<=np; j++) {
         st += wp[j] * Func(t[i],p[j], x, RadialP_R, RadialP_dR, N, n, l, m,dj, n1, l1,m1, dj1);
      }
      s += wt[i] * st;
   }
...
double qSimpsonAngS(double Func(double,double,double, int, int,int,int,int,int,int,int,int),
 int nt, int np, double x,int N,int n,int l,int m, int dj,int n1,int l1,int m1,int dj1)
//---------------------------------------------------------------------------
// Integrates function Func(theta,phi) on [0,pi] x [0,2*pi] in sperical
// coordinates using Simpson's rule with (nt x np) points
//---------------------------------------------------------------------------
...
#define pi 3.141592653589793
   ...
   for (i=1; i<=nt; i++) {
      st = 0e0;
      for (j=1; j<=np; j++) {
         st += wp[j] * Func(t[i],p[j], x, N, n, l, m,dj, n1, l1,m1, dj1);
      }
      s += wt[i] * st;
   }
