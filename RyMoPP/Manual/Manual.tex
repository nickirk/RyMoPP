...
\item when $m\neq0$, $Y_l^{m\neq0}(0,0)=0$.
\end{itemize}
However, for possible future adaptions of the code, we keep the general calculation of the derivative with respect to $\theta$ of the sperical harmonics instead of setting directly $PWS2=0$. 
